...
$svsim_constant_defaults = array(
	...
	'LOGGED_IN_SALT'     => '',
	'NONCE_SALT'         => '',
	'WP_SITEURL'         => 'http://local.svsim-workshop.dev',
	'WP_HOME'            => 'http://local.svsim-workshop.dev',
	);

foreach( $svsim_constant_defaults as $key => $value ) {
	if ( ! defined( $key ) ) {
		define( $key, $value );
	}
}
